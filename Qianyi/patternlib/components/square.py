"""A rectangular pattern: the smallest useful component."""
...
def build(params: dict) -> list[PatternSpec]:
    ...
    # Counter-clockwise loop; the first vertex is the pattern's reference point
    ...
    return [PatternSpec(name="square", vertices=vertices, edges=edges)]
