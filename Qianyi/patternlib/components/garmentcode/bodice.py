...
from ._kernel import (Segment, curve_from_tangents, insert_notches, line_segment,
                      quad_segment, segments_to_gcd_panel)
...
def build(params: dict):
    return [segments_to_gcd_panel("bodice_front_half", front_segments(params), scale=CM_TO_MM),
            segments_to_gcd_panel("bodice_back_half", back_segments(params), scale=CM_TO_MM)]
