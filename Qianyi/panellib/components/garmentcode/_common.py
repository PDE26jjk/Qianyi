...
def polygon_cm(name: str, vertices_cm) -> PanelSpec:
    ...
    return PanelSpec(name=name, vertices=scaled, edges=edges)


def name_side_edges(panel: PanelSpec, left_name: str = "left",
                    right_name: str = "right") -> PanelSpec:
    ...
    edges relabelled in place (``PanelSpec`` is a mutable record).
    """
