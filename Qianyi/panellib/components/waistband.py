"""A waistband: two panels joined by side seams, sized along the waist."""
...
LABEL = "Waistband"
CATEGORY = "Bands"
DESCRIPTION = "Front and back band panels sized from the waist length."
...
def _band(name: str, width: float, height: float, curve: float) -> PanelSpec:
