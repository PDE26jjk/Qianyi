"""A wide panel with many edges: the benchmark component."""
...
COMPONENT_ID = "pleated_panel"
VERSION = 1
LABEL = "Pleated Panel"
CATEGORY = "Panels"
DESCRIPTION = "A rectangle whose top edge is folded into many teeth; used to time large panels."
...
def build(params: dict) -> list[PanelSpec]:
    ...
    # The zigzag is built with numpy: a panel with a thousand edges should not
    ...
    return [PanelSpec(name="pleated", vertices=vertices, edges=edges)]
