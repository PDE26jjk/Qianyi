...
from ._kernel import (Segment, cut_corner_segments, line_segment,
                      rel_to_abs_2d, segment_length, segments_to_panel)
from ._panels import circle_arc_spec, straight_band
...
def compose_shirt(front, back, front_armhole_width, back_armhole_width,
    ...
    panels = [
        segments_to_panel(front_name, front, scale=CM_TO_MM),
        segments_to_panel(back_name, back, scale=CM_TO_MM),
    ]
    if not sleeveless:
    ...
    if style == "Turtle":
        ...
        hood = hood_spec("hood", front_depth, back_depth, front_length, back_length,
                         ...
                         hood_depth)
        panels.append(segments_to_panel("hood", hood, scale=CM_TO_MM))
    return panels
