...
from .skirt_panel import skirt_pattern_spec
...
def build(params: dict):
    ...
    return [
        name_side_edges(skirt_pattern_spec("skirt_front", adjusted_waist - adjusted_back_waist,
                                         length, ruffle, flare, bottom_cut)),
        name_side_edges(skirt_pattern_spec("skirt_back", adjusted_back_waist,
                                         length, ruffle, flare, bottom_cut)),
    ]
